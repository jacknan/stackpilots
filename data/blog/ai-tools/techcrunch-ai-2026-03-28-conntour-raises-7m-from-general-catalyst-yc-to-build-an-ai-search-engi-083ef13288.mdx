...
draft: false
summary: 'Conntour raises $7M from General Catalyst, YC to build an AI search engine for security video systems is relevant to security engineering teams right now. This analysis translates the update into practical engineering im'
layout: PostSimple
---

## What happened

Conntour raises $7M from General Catalyst, YC to build an AI search engine for security video systems signals a relevant change for teams working on developer tools and AI-enabled delivery workflows.
...
- Original article: [Conntour raises $7M from General Catalyst, YC to build an AI search engine for security video systems](https://techcrunch.com/2026/03/26/conntour-raises-7m-from-general-catalyst-yc-to-build-an-ai-search-engine-for-security-video-systems/)
- Published: Thu, 26 Mar 2026 13:41:00 +0000
