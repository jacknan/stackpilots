...
date: 2026-03-23T04:00:34.036Z
tags: ['ai-tools', 'industry-news', 'software-engineering']
draft: false
summary: 'Cursor admits its new coding model was built on top of Moonshot AI’s Kimi is relevant to software engineering teams right now. This analysis translates the update into practical engineering implications and action items.'
layout: PostSimple
---

## What happened

Cursor admits its new coding model was built on top of Moonshot AI’s Kimi signals a relevant change for teams working on developer tools and AI-enabled delivery workflows.
...
- Original article: [Cursor admits its new coding model was built on top of Moonshot AI’s Kimi](https://techcrunch.com/2026/03/22/cursor-admits-its-new-coding-model-was-built-on-top-of-moonshot-ais-kimi/)
