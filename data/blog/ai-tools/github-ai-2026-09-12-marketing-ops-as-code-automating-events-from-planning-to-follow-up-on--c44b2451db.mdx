...
draft: false
summary: 'If you can write down how you do your work, you can automate it. Here''s what I did to support GitHub''s APAC marketing team. The post Marketing ops as code: Automating eve This analysis translates the update into practi'
layout: PostSimple
---
...
- Original article: [Marketing ops as code: Automating events from planning to follow-up on GitHub](https://github.blog/ai-and-ml/github-copilot/marketing-ops-as-code-automating-events-from-planning-to-follow-up-on-github/)
