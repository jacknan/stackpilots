...
date: 2026-06-16T06:43:29.949Z
tags: ['ai-tools', 'industry-news', 'software-engineering']
draft: false
summary: 'As AI agents become employees, NewCore emerges with $66M to give them identities is relevant to developer tooling teams right now. This analysis translates the update into practical engineering implications and action it'
layout: PostSimple
---

## What happened

As AI agents become employees, NewCore emerges with $66M to give them identities signals a relevant change for teams working on developer tools and AI-enabled delivery workflows.
...
- Original article: [As AI agents become employees, NewCore emerges with $66M to give them identities](https://techcrunch.com/2026/06/15/ai-agents-are-becoming-employees-newcore-emerges-with-66m-to-give-them-identities/)
