...
date: 2026-09-03T05:51:28.838Z
tags: ['ai-tools', 'industry-news', 'software-engineering']
draft: false
summary: 'US government sides with OpenAI on issue of training LLMs on copyrighted material is relevant to software engineering teams right now. This analysis translates the update into practical engineering implications and actio'
layout: PostSimple
---

## What happened

US government sides with OpenAI on issue of training LLMs on copyrighted material signals a relevant change for teams working on developer tools and AI-enabled delivery workflows.
...
- Original article: [US government sides with OpenAI on issue of training LLMs on copyrighted material](https://techcrunch.com/2026/09/02/u-s-government-sides-with-openai-on-issue-of-training-llms-on-copyrighted-material/)
