...
date: 2026-09-21T06:24:55.059Z
tags: ['ai-tools', 'industry-news', 'software-engineering']
draft: false
summary: 'Microsoft exec called AI scraping ‘the largest theft of labor in human history,&#8217; new unredacted filings reveal is relevant to platform engineering teams right now. This analysis translates the update into practical'
layout: PostSimple
---

## What happened

Microsoft exec called AI scraping ‘the largest theft of labor in human history,&#8217; new unredacted filings reveal signals a relevant change for teams working on developer tools and AI-enabled delivery workflows.
...
- Original article: [Microsoft exec called AI scraping ‘the largest theft of labor in human history,&#8217; new unredacted filings reveal](https://techcrunch.com/2026/09/17/microsoft-exec-called-ai-scraping-the-largest-theft-of-labor-in-human-history-new-unredacted-filings-reveal/)
