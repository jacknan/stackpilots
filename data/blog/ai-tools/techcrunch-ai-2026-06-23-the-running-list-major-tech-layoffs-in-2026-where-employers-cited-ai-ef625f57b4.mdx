...
date: 2026-06-23T05:14:34.286Z
tags: ['ai-tools', 'industry-news', 'software-engineering']
draft: false
summary: 'The running list: major tech layoffs in 2026 where employers cited AI is relevant to software engineering teams right now. This analysis translates the update into practical engineering implications and action items.'
layout: PostSimple
---

## What happened

The running list: major tech layoffs in 2026 where employers cited AI signals a relevant change for teams working on developer tools and AI-enabled delivery workflows.
...
- Original article: [The running list: major tech layoffs in 2026 where employers cited AI](https://techcrunch.com/2026/06/22/the-running-list-major-tech-layoffs-in-2026-where-employers-cited-ai/)
- Published: Tue, 23 Jun 2026 01:27:55 +0000
