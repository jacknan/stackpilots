...
draft: false
summary: 'Anthropic and Gov. Newsom forge deal allowing California government to use Claude at half price is relevant to developer tooling teams right now. This analysis translates the update into practical engineering implication'
layout: PostSimple
---

## What happened

Anthropic and Gov. Newsom forge deal allowing California government to use Claude at half price signals a relevant change for teams working on developer tools and AI-enabled delivery workflows.
...
- Original article: [Anthropic and Gov. Newsom forge deal allowing California government to use Claude at half price](https://techcrunch.com/2026/06/29/anthropic-and-gov-newsom-forge-deal-allowing-california-government-to-use-claude-at-half-price/)
