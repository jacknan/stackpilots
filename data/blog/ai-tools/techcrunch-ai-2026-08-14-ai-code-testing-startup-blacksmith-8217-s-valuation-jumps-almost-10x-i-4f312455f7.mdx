...
draft: false
summary: 'AI code-testing startup Blacksmith&#8217;s valuation jumps almost 10x in less than a year is relevant to software engineering teams right now. This analysis translates the update into practical engineering implications a'
layout: PostSimple
---

## What happened

AI code-testing startup Blacksmith&#8217;s valuation jumps almost 10x in less than a year signals a relevant change for teams working on developer tools and AI-enabled delivery workflows.
...
- Original article: [AI code-testing startup Blacksmith&#8217;s valuation jumps almost 10x in less than a year](https://techcrunch.com/2026/08/12/blacksmiths-valuation-jumps-10x-to-550m-as-ai-coding-fuels-software-validation/)
- Published: Wed, 12 Aug 2026 11:00:00 +0000
