...
draft: false
summary: 'Copilot is ‘for entertainment purposes only,’ according to Microsoft’s terms of use is relevant to developer tooling teams right now. This analysis translates the update into practical engineering implications and action'
layout: PostSimple
---

## What happened

Copilot is ‘for entertainment purposes only,’ according to Microsoft’s terms of use signals a relevant change for teams working on developer tools and AI-enabled delivery workflows.
