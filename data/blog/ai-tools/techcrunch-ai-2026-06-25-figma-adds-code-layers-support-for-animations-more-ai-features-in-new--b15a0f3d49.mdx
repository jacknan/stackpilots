...
draft: false
summary: 'Figma adds code layers, support for animations, more AI features in new update is relevant to software engineering teams right now. This analysis translates the update into practical engineering implications and action i'
layout: PostSimple
---

## What happened

Figma adds code layers, support for animations, more AI features in new update signals a relevant change for teams working on developer tools and AI-enabled delivery workflows.
...
- Original article: [Figma adds code layers, support for animations, more AI features in new update](https://techcrunch.com/2026/06/24/figma-adds-code-layers-support-for-animations-more-ai-features-in-new-update/)
- Published: Wed, 24 Jun 2026 16:15:00 +0000
