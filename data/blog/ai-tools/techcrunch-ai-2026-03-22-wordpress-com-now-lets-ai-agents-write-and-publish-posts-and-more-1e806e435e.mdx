...
draft: false
summary: 'WordPress.com now lets AI agents write and publish posts, and more is relevant to developer tooling teams right now. This analysis translates the update into practical engineering implications and action items.'
layout: PostSimple
---

## What happened

WordPress.com now lets AI agents write and publish posts, and more signals a relevant change for teams working on developer tools and AI-enabled delivery workflows.
...
- Original article: [WordPress.com now lets AI agents write and publish posts, and more](https://techcrunch.com/2026/03/20/wordpress-com-now-lets-ai-agents-write-and-publish-posts-and-more/)
- Published: Fri, 20 Mar 2026 16:43:09 +0000
