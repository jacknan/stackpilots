...
date: 2026-04-02T04:01:32.884Z
tags: ['ai-tools', 'industry-news', 'software-engineering']
draft: false
summary: 'Popular AI gateway startup LiteLLM ditches controversial startup Delve is relevant to software engineering teams right now. This analysis translates the update into practical engineering implications and action items.'
layout: PostSimple
---

## What happened

Popular AI gateway startup LiteLLM ditches controversial startup Delve signals a relevant change for teams working on developer tools and AI-enabled delivery workflows.
...
- Original article: [Popular AI gateway startup LiteLLM ditches controversial startup Delve](https://techcrunch.com/2026/03/30/popular-ai-gateway-startup-litellm-ditches-controversial-startup-delve/)
