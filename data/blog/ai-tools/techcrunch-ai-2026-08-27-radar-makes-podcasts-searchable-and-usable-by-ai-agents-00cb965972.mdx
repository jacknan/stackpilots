...
date: 2026-08-27T11:12:58.790Z
tags: ['ai-tools', 'industry-news', 'software-engineering']
draft: false
summary: 'Radar makes podcasts searchable — and usable by AI agents is relevant to developer tooling teams right now. This analysis translates the update into practical engineering implications and action items.'
layout: PostSimple
---

## What happened

Radar makes podcasts searchable — and usable by AI agents signals a relevant change for teams working on developer tools and AI-enabled delivery workflows.
...
- Original article: [Radar makes podcasts searchable — and usable by AI agents](https://techcrunch.com/2026/08/26/radar-makes-podcasts-searchable-and-usable-by-ai-agents/)
