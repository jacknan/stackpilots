...
draft: false
summary: 'Databricks bought two startups to underpin its new AI security product is relevant to security engineering teams right now. This analysis translates the update into practical engineering implications and action items.'
layout: PostSimple
---

## What happened

Databricks bought two startups to underpin its new AI security product signals a relevant change for teams working on developer tools and AI-enabled delivery workflows.
...
- Original article: [Databricks bought two startups to underpin its new AI security product](https://techcrunch.com/2026/03/24/databricks-buys-two-startups-lakewatch-antimatter-siftd-ai-security/)
- Published: Tue, 24 Mar 2026 20:40:56 +0000
